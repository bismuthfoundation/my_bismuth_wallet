...
public class Vault {
    ...
    private static final String AUTOMATICALLY_KEYED_PREF_FILE_NAME = "io.reddwarf.my_bismuth_wallet.automaticallyKeyedPref";
    private static final String AUTOMATICALLY_KEYED_KEY_FILE_NAME = "io.reddwarf.my_bismuth_wallet.automaticallyKeyedKey";
    private static final String AUTOMATICALLY_KEYED_KEY_ALIAS = "io.reddwarf.my_bismuth_wallet.automaticallyKeyed";
