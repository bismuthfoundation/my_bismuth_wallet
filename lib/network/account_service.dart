...
import 'package:my_idena_wallet/network/model/request/account_info_request.dart';
import 'package:my_idena_wallet/network/model/request/block_info_request.dart';
import 'package:my_idena_wallet/network/model/response/account_info_response.dart';
...
import 'package:my_idena_wallet/model/state_block.dart';
import 'package:my_idena_wallet/network/model/base_request.dart';
import 'package:my_idena_wallet/network/model/request_item.dart';
...
import 'package:my_idena_wallet/network/model/request/accounts_balances_request.dart';
import 'package:my_idena_wallet/network/model/request/pending_request.dart';
import 'package:my_idena_wallet/network/model/request/process_request.dart';
import 'package:my_idena_wallet/network/model/response/account_history_response.dart';
import 'package:my_idena_wallet/network/model/response/block_info_item.dart';
...
const String _SERVER_ADDRESS = "wss://api.idena.io";
const String _SERVER_ADDRESS_HTTP = "https://api.idena.io";
...
class AccountService {
  ...
  Future<AccountHistoryResponse> requestAccountHistory(String account, { int limit = 1}) async {
    ...
    try {
      HttpClientRequest request = await httpClient
          .getUrl(Uri.parse("https://api.idena.io/api/Address/0xf2b4f700d2975abd39000587f9788f66afedf691/Txs?limit=12"));
