...
import 'package:my_idena_wallet/util/idena_ffi/blocks/state_block.dart';
import 'package:my_idena_wallet/util/idena_ffi/signing/signer.dart';
...
class StateBlock {
  ...
  Future<String> sign(String privateKey) async {
    ...
    this.hash = IdenaBlocks.computeStateHash(this.account,
                      this.previous,
                      this.representative,
                      BigInt.parse(this.balance),
                      this.link
                  );
    this.signature = IdenaSignatures.signBlock(this.hash, privateKey);
